...
\label{theo:theorem}
 ...
 attachment vertices shown in the boundary of the disk (or pinched disk, in the case of the right coin of
 $\mu_{20}$) where the coin lies as small white circles. 
