...
\label{theo:theorem}
 ...
 where the coin lies. The number $k$ of such attachment vertices satisfies $k\in \{0,1,2,3,4\}$.
...
In blackboard framed language, this move
is conveniently depicted via the heiroglyph shown above. See Section 12.3 of \cite{kauffman1994tlr}
.}
...
\caption{Blackboard framed version of Martelli's revised calculus with $a_3$, $a_4$ replacing $A_3$, $A_4$. 
