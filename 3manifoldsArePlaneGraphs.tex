...
used throughout the paper. Moreover, I present a short historic overview of the known results.

\subsubsection{Formal definitions for the various types of links}

We need to define vaious types of links:
link, framed link, blackboard framed link, fractionary framed link,
integer framed link, bflink, blink, g-blink.
...
by Lickorish satisfy $q=1$. He call these surgeries honest.
...
\caption{\sf Martelli's calculus on fractionary framed links.
