...
\label{theo:theorem}
 ...
 Vertices internal  to the coins are shown as small black disks. 
 ...
 attachment vertices shown in the boundary of the coin as small white circles. 
...
I use another way to decorate the link projections: the images of the link components are thich black curves
...
arbitrarily in  $\mathbb{S}^3$ while connecting
...
I have reasons to believe that a pair of blinks (related in a still mysterious way)
(and the associated graphic matroids) 
is a complete invariant for these manifolds. A catalogue of
all the 242 blinks which are $3$-connected, monochromatic 
and have up to 16 edges appear in \cite{lins2007blink}.
(2) The theorem established in this work brings closer of being true an old quest of mine: 
is there a way to associate a matroidal invariant to a 3-manifold?
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=1.2]{A.figs/prime191Blinks.pdf}
\caption{\sf The first 191 closed, oriented, connected and prime 3-manifolds. 
These are such 3-manifolds which are induced by blinks up to 8 edges.}
\label{fig:prime191Blinks}
\end{center}
\end{figure}
