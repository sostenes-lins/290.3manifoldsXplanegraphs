...
between 3-manifolds and plane graphs. The concept of {\em flink}, a new object which
generalizes {\em blackboard framed link}, is a central object in this work.
\end{abstract}
...
\raisebox{-3mm}{\includegraphics[width=7cm]{A.figs/reidemeistermoves.pdf}}. The {\em writhe 
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=13.0cm]{A.figs/surgerycoefficientsfromflink.pdf} 
...
reformulation provide trully local moves.
}
...
above algorithm to unknot any knot and of Kirby's calculus on flinks, as shown in Fif.
\ref{fig:switchingcrossing}.
\begin{figure}[H]
\begin{center}
...
some curls: this is achieved by applying Kirby move 1 and twice Kirby moves 2 as well
...
for the revised Martelli's moves on pairs of distinctly 2-colored flinks 
and the respective blinks superimposed. The result follows by removing the 
flink moves leaving only the blink moves which are redrawn up to isotopy,
